...
<h3>Aprimorando meus conhecimentos do JavaScript.</h3>
<p>O intuito da criação deste projeto foi treinar meus conhecimentos em HTML5, CSS e JavaScript, criando uma página de vendas simples,
  intuitiva e funcional, com um visual voltado para o mundo dos games.</p>

<div>
  <img max-width="100%" src="https://github.com/devNeiBarbosa/Site-Valorant-points/blob/main/assets/img/banner%20valorant-points.png"/>
</div>
